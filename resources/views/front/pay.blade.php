    ...
    <div class="container pt-5">
        ...
        <div id="delivery-info" class="border py-3 px-5 mb-3">
            ...
            <div class="d-flex mb-3">
                ...
                <input type="text" class="col-6 p-2" name="postal_code" id="postal_code_input" placeholder="郵遞區號"
                    required>
            </div>
            <input type="text" class="w-100 p-2 mb-3" name="address" id="address_input" placeholder="區,街道,巷弄,門號,樓層"
                required>
            <div class="d-flex">
